...
public class TestJFunction {
  /**
   * This function listens at endpoint "/api/TestJFunction". Two ways to invoke it using "curl"
   * command in bash: 1. curl -d "HTTP Body" {your host}/api/TestJFunction 2. curl {your
   * host}/api/TestJFunction?name=HTTP%20Query
   */
